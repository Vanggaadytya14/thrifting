...
<link rel="stylesheet" type="text/css" href="{{ url('css/regular_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{ url('css/regular_responsive.css')}}">
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="/home">Moon.Co</a></div>
						</div>
					</div>
...
<script src="{{ url ( 'assets/js/regular_custom.js')}}"></script>
</body>
